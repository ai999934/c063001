...
main()
{
    ...
    g.plot_deq(2, x_start, k, y, y[0], d, deqs);
    
    gend();
}

// g++ c062925.cpp libglibw32-3.a -IC:\mingw-jp-20040217\include\ -LC:\mingw-jp-20040217\lib\ -IC:\Glibw32\ -LC:\Glibw32\ -luser
// 32 -lgdi32
// rename a.exe c062925.*
// c062925.exe
